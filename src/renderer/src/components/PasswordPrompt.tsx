  ...
  return (
    ...
    >
      ...
      <input
        autoFocus
        type="password"
        className="w-full rounded-lg border border-line bg-ink/60 px-3 py-2 text-sm text-fg outline-none transition-colors placeholder:text-faint focus:border-accent/60 focus:ring-2 focus:ring-accent/15"
        value={value}
